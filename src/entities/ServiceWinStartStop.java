...
public class ServiceWinStartStop {
	
	static final String CMD_START = "cmd /c net start \"";	
	static final String CMD_STOP = "cmd /c net stop \"";

//	public static int startService(String batName) throws Exception {
//		return execCmd(batName);
//	}
	...
	static int execCmd(String cmdLine) throws Exception {
		...
		//System.out.println("cmd /c start \""+ cmdLine +"\"" );
		//Process process = Runtime.getRuntime().exec("cmd /c start \""+ cmdLine +"\""  );
